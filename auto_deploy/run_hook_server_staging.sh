...
nohup python -m hook_server --code_base_dir "$code_base_dir" --image_version "$image_version" --host "$host_bind" --port "$port_bind" --target_branch staging > ./hook_server.log 2>&1 &
