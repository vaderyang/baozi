...
nohup python -m auto_deploy.hook_server --code_base_dir "$code_base_dir" --image_version "$image_version" --host "$host_bind" --port "$port_bind" > ./auto_deploy.staging.log 2>&1 &
