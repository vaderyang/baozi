...
- [x] 1. Create database migration and TranscriptionJob model
...
- [x] 2. Implement TranscriptionTask background worker
...
- [x] 3. Create TranscriptionStatusCard ProseMirror node
...
- [x] 4. Modify transcription API endpoints
- [x] 4.1 Update transcriptions.create endpoint for async operation
...
- [x] 4.2 Create transcriptions.info endpoint
...
- [x] 4.3 Create transcriptions.retry endpoint
...
- [x] 4.4 Create transcriptions.cancel endpoint
...
- [x] 5. Implement WebSocket event handling
...
- [x] 6. Create TranscriptionStatusManager frontend component
...
- [x] 7. Update editor menu integration
...
- [x] 9. Implement cleanup task for old jobs
...
- [x] 10. Add job resumption on server restart
...
- [x] 11. Implement document load job query
...
- [x] 12. Add translations for new UI elements
